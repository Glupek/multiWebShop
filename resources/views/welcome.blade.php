...
<section id="productsWelcome" class="container mt-5">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>Welkom</h1>
            <p>Welkom bij RetroDreams , wij zoeken voor jullie door heel europa naar games in goeie staat</p>
        </div>
    </div>
         ...
         <div id="mijnCard" class="col-md-3 mb-3">
             <div  class="card">
                 ...
                 <div class="card-body">
                     ...
                     <a href="/products/{{ $product->product_id }}" class="btn btn-primary">Meer info</a>
                     <div>
